...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 369 376 369 376 0 0 0 0
#  380 380 369 376 369 376 380 380 380 380
...
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF, beg_mean recruits, end_recruits  (enter actual year, or values of 0 or -integer to be rel. endyr)
 369 376 369 376 -999 0
#  369 376 369 376 193 380
...
408 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
381 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
