...
8 # MCeval thin interval
0 # jitter initial parm value by this fraction
-1 # min yr for sdreport outputs (-1 for styr); #_1983
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2024
...
5 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 4 15 #_min and max age over which average F will be calculated, with F=Z-M
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1728380603
