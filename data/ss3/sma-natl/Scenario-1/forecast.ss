...
#C Fisheries Research Special Publication on Next Generation General Stock Assessment Models (NGGSAM)
#C Carvalho et al. (Draft October 2020) "A Cookbook for Using Model Diagnostics in Integrated Stock Assessments" 
#C ICCAT 2017 North Atlantic Shortfin Mako (SMA) Model Run 3
#C Adapted from Stock Synthesis v 3.24U (control.ss_new; data.ss_new; forecast.ss_new; starter.ss_new) as described in: 
#C Anon. 2017. Report of the 2017 Shortfin Mako Assessment Meeting (Madrid, Spain 12–16 June 2017).Collect. Vol. Sci. Pap. ICCAT, 74(4):1465–1561.
#C Courtney, D., Carvalho, C. Winker, H., and L. Kell. 2020. Examples of Stock Synthesis diagnostic methods and results implemented for previously completed North Atlantic shortfin mako Stock Synthesis model runs. SCRS/2019/088. Collect. Vol. Sci. Pap. ICCAT, 76(10): 173-234. 
...
1 # Control rule inflection for constant F (as frac of Bzero, e.g. 0.40); must be > control rule cutoff, or set to -1 to use Bmsy/SSB_unf 
...
2024 # 2016 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
