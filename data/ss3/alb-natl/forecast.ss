...
#C file write time: 2023-04-28 16:20:22
...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 -2 0 -2 0 -2 0 -999 0 -999 0
#  1930 2021 1930 2021 1930 2021 1930 2021 1930 2021
...
50 # N forecast years 
0.8 # Fmult (only used for Do_Forecast==5) such that apical_F(f)=Fmult*relF(f)
...
0.05 # Control rule inflection for constant F (as frac of Bzero, e.g. 0.40); must be > control rule cutoff, or set to -1 to use Bmsy/SSB_unf 
0.025 # Control rule cutoff for no F (as frac of Bzero, e.g. 0.10) 
0.8 # Buffer:  enter Control rule target as fraction of Flimit (e.g. 0.75), negative value invokes list of [year, scalar] with filling from year to YrMax 
...
2050 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
