...
#C file write time: 2023-08-08 12:06:04.009284
data.ss
control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1950
...
3 7 #_min and max age over which average F will be calculated with F_reporting=4 or 5
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1692100363
