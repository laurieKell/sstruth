...
#C file write time: 2025-05-05  11:32:36
data.ss
control.ss
0 # 0=use init values in control file; 1=use ss.par
1 # 2 # run display detail (0 = minimal; 1=one line per iter; 2=each logL)
...
-1 # min year for sdreport outputs (-1 for styr); #_1948
-2 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2016
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1746463470
