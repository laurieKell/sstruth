...
11 # min yr for sdreport outputs (-1 for styr)
336 # max yr for sdreport outputs (-1 for endyr; -2 for endyr+Nforecastyrs
...
4 # F_report_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Frates); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 1 28 #_min and max age over which average F will be calculated
